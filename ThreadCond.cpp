...
int ThreadCond::thread_cond_create(pthread_cond_t* cond)
{
	int  err;
...
int ThreadCond::thread_cond_destroy(pthread_cond_t* cond)
{
	int  err;
...
int ThreadCond::thread_cond_signal(pthread_cond_t* cond)
{
	int  err;
...
int ThreadCond::thread_cond_wait(pthread_cond_t* cond, pthread_mutex_t* mtx)
{
